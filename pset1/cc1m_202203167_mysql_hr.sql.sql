...
ALTER TABLE departamentos
    ADD CONSTRAINT departamentos__localizacoes_fk FOREIGN KEY (id_localizacao) REFERENCES localizacoes(id_localizacao);

ALTER TABLE departamentos
    ADD CONSTRAINT departamentos_fk FOREIGN KEY (id_gerente) REFERENCES empregados(id_empregado);

ALTER TABLE empregados
    ADD CONSTRAINT empregados_cargos_fk FOREIGN KEY (id_cargo) REFERENCES cargos(id_cargo);

ALTER TABLE empregados
    ADD CONSTRAINT empregados_fk FOREIGN KEY (id_departamento) REFERENCES departamentos(id_departamento);

ALTER TABLE empregados
    ADD CONSTRAINT empregados_supervisor_FK FOREIGN KEY (id_supervisor) REFERENCES empregados(id_empregado);

ALTER TABLE historico_cargos
    ADD CONSTRAINT historico_cargos_cargos_fk FOREIGN KEY (id_cargo) REFERENCES cargos(id_cargo);

ALTER TABLE historico_cargos
    ADD CONSTRAINT historico_cargos_empregados_fk FOREIGN KEY (id_empregado) REFERENCES empregados(id_empregado);

ALTER TABLE historico_cargos
    ADD CONSTRAINT historico_cargos_fk FOREIGN KEY (id_departamento) REFERENCES departamentos(id_departamento);

ALTER TABLE localizacoes
    ADD CONSTRAINT localizacoes_fk FOREIGN KEY (id_pais) REFERENCES paises(id_pais);

ALTER TABLE paises
    ADD CONSTRAINT paises_fk FOREIGN KEY (id_regiao) REFERENCES regioes(id_regiao);

CREATE UNIQUE INDEX departamentos_nome_IDX USING BTREE ON departamentos (nome);
